...
export class EventoService {
  ...
  crearEvento(id: String, nombre: String, descripcion: String, fechaInicio: Date,
    ...
    return this.http
      .post(url, JSON.stringify({
        ...
        fechaFin: fechaFin, datosGeojson: datosGeojson
  ...
  createEventoAcademico(id: String, nombre: String, descripcion: String, fechaInicio: Date,
    ...
    var url = this.eventoAcademicoUrl + '/' + id;
    return this.http
      .post(url, JSON.stringify({
        nombre: nombre, descripcion: descripcion, fechaInicio: fechaInicio,
        fechaFin: fechaFin, datosGeojson: datosGeojson, tipo: tipo
      }), { headers: this.headers })
      .toPromise()
      .then(res => {
        return res.json();
  ...
  createReunionSocial(id: String, nombre: String, descripcion: String, fechaInicio: Date,
    ...
    return this.http
      .post(url, JSON.stringify({
        nombre: nombre, descripcion: descripcion, fechaInicio: fechaInicio,
        fechaFin: fechaFin, datosGeojson: datosGeojson, dinero: dinero
      }), { headers: this.headers })
      .toPromise()
      .then(res => {
        return res.json();
  ...
  createReunionLaboral(id: String, nombre: String, descripcion: String, fechaInicio: Date,
    ...
    return this.http
      .post(url, JSON.stringify({
        nombre: nombre, descripcion: descripcion, fechaInicio: fechaInicio,
        fechaFin: fechaFin, datosGeojson: datosGeojson, participantes: participantes
      }), { headers: this.headers })
      .toPromise()
      .then(res => {
        return res.json();
